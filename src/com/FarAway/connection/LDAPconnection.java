 ...
 */
package com.FarAway.connection;
...
public class LDAPconnection extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        final String DB_URL = "jdbc:mysql://localhost:3306/faraway";

        //  Database credentials
        final String DBUSER = "root";
        final String DBPASS = "admin";
        ...
        System.out.println("ldap.auth() " + ldap.auth());
//        logWriter.close();
        ...
        if (ldap.auth()) {
            try {
                ...
                String savePath = appPath + "users" + File.separator + username;
                ...
                loginCookie.setPath("/FarAway/");
                //setting cookie to expiry in 30 mins
                loginCookie.setMaxAge(30 * 60);
                response.addCookie(loginCookie);

                
                System.out.println("Searching Cookie "+loginCookie.getName());
                Cookie[] cookies = request.getCookies();
                if (cookies != null) {
                    for (Cookie cookie : cookies) {
                        System.out.println("cookies: "+cookie.getName());
                        if (cookie.getName().equals("user")) {
                            System.out.println("Login Cookie Deployed!!");
                        }
                    }
                }
