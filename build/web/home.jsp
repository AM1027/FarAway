...
<sql:query var="renting" dataSource="jdbc/houses">
    SELECT id, owner, location, size, date_from, date_to FROM faraway.houses
</sql:query>
...
<%
    request.setAttribute("pageHeading", "FarAway");
%>
...
<div class="center">
    <form action="searchdb.jsp" class="" name="renting" method="POST">
